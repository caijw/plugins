...
void BinderPlugin::RegisterWithRegistrar(
  ...
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "binder",
          &flutter::StandardMethodCodec::GetInstance());
  auto plugin = std::make_unique<BinderPlugin>();
...
void BinderPluginRegisterWithRegistrar(
  ...
  BinderPlugin::RegisterWithRegistrar(insert_result.first->second.get());
}
